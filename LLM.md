...
| Local incremental cache            | Skip work when inputs unchanged                                 | ◐ Partial. Per-module mtime checks against a per-module timestamp file. No content-addressed hashing.   |
