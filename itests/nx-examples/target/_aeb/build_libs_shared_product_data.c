...
int build_libs_shared_product_data(void* s) {
void* b = build_begin(s, "libs/shared/product/data");
if ((intptr_t)b == 0) {
        {
            return 0;
        }
    }
build_load_deps_file(b, "../../../../base.deps.ae");
build_dep(b, "libs/shared/product/types");
    {
        void* _bcfg = map_new();
